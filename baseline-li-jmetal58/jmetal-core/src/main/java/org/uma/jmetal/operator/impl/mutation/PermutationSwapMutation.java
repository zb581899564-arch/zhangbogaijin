...
public class PermutationSwapMutation<T> implements MutationOperator<PermutationSolution<T>> {
  ...
  private int mutationprobabilityflag;
   ...
   * Constructor
   */
  public PermutationSwapMutation(double mutationProbability, RandomGenerator<Double> mutationRandomGenerator, BoundedRandomGenerator<Integer> positionRandomGenerator) throws JMetalException {
  ...
  public int getMutationProbabilityflag() {
    return mutationprobabilityflag;
  }
