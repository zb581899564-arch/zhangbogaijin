...
public class NSGAIIBuilder<S extends Solution<?>> implements AlgorithmBuilder<NSGAII<S>> {
  ...
  public NSGAIIBuilder setCrossoverRate(double Cross_c) {
    this.crossoverRate = Cross_c;
    return this ;
  }
  public NSGAIIBuilder setMutationRate(double Mutation_m) {
  ...
  public NSGAIIBuilder<S> setCrossoverRates4worker(double CrossoverRates4worker) {
    this.CrossoverRates4worker = CrossoverRates4worker;
    return this ;
  }

  public NSGAIIBuilder<S> setCrossoverRates4machine(double CrossoverRates4machine) {
  ...
  public NSGAIIBuilder<S> setMutationRate4worker(double mutationRate4worker) {
    this.mutationRate4worker = mutationRate4worker;
    return this ;
  }

  public NSGAIIBuilder<S> setMutationRate4machine(double mutationRate4machine) {
...
//              crossoverOperator,
//          mutationOperator, selectionOperator, dominanceComparator, evaluator,crossoverRate, mutationRate,CrossoverRates4worker,CrossoverRates4machine,mutationRate4worker,mutationRate4machine);// TODO 20211009
...
//          mutationOperator, selectionOperator, dominanceComparator, evaluator,crossoverRate, mutationRate);
...
//              crossoverOperator, mutationOperator, selectionOperator, dominanceComparator, evaluator,crossoverRate, mutationRate);
...
//  }
  ...
  public NSGAII<S> build(){
    ...
    algorithm = new NSGAII<S>(problem, maxEvaluations, populationSize, matingPoolSize, offspringPopulationSize,
            crossoverOperator,
            mutationOperator, selectionOperator, dominanceComparator, evaluator,crossoverRate, mutationRate,CrossoverRates4worker,CrossoverRates4machine,mutationRate4worker,mutationRate4machine);
