...
public class MOHEADE <S extends Solution<?>> extends AbstractGeneticAlgorithmS<S, List<S>> {
    ...
    public MOHEADE(Problem<S> problem, int maxIterations, int populationSize,
