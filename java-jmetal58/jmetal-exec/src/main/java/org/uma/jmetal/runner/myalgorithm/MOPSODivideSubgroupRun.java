...
public class MOPSODivideSubgroupRun extends AbstractAlgorithmRunner {
    ...
    public static void main(String[] args) throws Exception {
       ...
       for (int i = 0; i < 30; i++) {
            ...
            algorithm = new MOPSODivSubBuilder(problem, upSize, centralSize, downSize)
            ...
            //A.shuchu(population,"算法1");//输出精英解到问题文件
           ...
           /*
            ...
            if (!referenceParetoFront.equals("")) {
                printQualityIndicatorstest(population, referenceParetoFront,"MOPSODS");
            }
