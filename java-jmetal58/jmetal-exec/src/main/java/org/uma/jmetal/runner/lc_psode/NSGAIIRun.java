...
public class NSGAIIRun extends AbstractAlgorithmRunner {

    private static String algorithmName = new String("NSGA-II");
    ...
    public static void mainexe(PermutationProblem<PermutationSolution<Integer>> problem,
        ...
        if (Nonparametric == false) {
            ...
            crossover = new PMXCrossover(pmxCrossover); //TODO check crossover
            //double mutationProbability = 0.3;
            double mutationProbability = V1mutationProbability; //TODO check mutation
            ...
            for (int i = 0; i < runIndex; i++) {
                algorithm = new NSGAIIBuilder<PermutationSolution<Integer>>(problem, crossover, mutation, swarmSize)
                        .setSelectionOperator(selection)
                        .setMaxEvaluations(maxIterations)  //最大代
                ...
                //utilDominationRelationship.shuchu(population, "NSGAII", numberOfJobs, numberOfMachines, snumber, datafile);//输出精英解到问题文件
                ...
                //System.out.println(numberOfJobs+"_"+numberOfMachines+"_"+snumber+"_算法NSGAII第" + i + "次结束");
            }
