...
import org.uma.jmetal.algorithm.multiobjective.mypso.MOPSODSDE_KmeansBuilder;
import org.uma.jmetal.algorithm.multiobjective.mypso.MOPSODivSubDEBuilder;
import org.uma.jmetal.algorithm.multiobjective.mypso.MOPSODS_KmeansBuilder;
...
public class MOPSODS_KmeansRun extends AbstractAlgorithmRunner {

    private static String algorithmName = new String("MOPSODS_Kmeans");
    ...
    public static void mainexe(PermutationProblem<PermutationSolution<Integer>> problem,
        ...
        if (Nonparametric == false) {
            ...
            for (int i = 0; i < runIndex; i++) {
                ...
                algorithm = new MOPSODS_KmeansBuilder(problem, swarmSize, numberOffactories,pmxCrossover)
