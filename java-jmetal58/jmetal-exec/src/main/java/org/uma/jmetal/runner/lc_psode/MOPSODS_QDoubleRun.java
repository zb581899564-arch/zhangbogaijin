...
import org.uma.jmetal.algorithm.multiobjective.mypso.MOPSODS_QDoubleBuilder;
...
public class MOPSODS_QDoubleRun extends AbstractAlgorithmRunner {

    private static String algorithmName = new String("MOPSODSQDouble");
    ...
    public static void mainexe(PermutationProblem<PermutationSolution<Integer>> problem,
        ...
        if (Nonparametric == false) {
            ...
            for (int i = 0; i < runIndex; i++) {
                ...
                algorithm = new MOPSODS_QDoubleBuilder(problem, swarmSize, DERate, DEcrossoverRates, DEmutationRate,pmxCrossover)
