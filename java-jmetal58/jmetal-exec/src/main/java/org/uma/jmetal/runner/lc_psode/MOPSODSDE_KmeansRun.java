...
public class MOPSODSDE_KmeansRun extends AbstractAlgorithmRunner {

    private static String algorithmName = new String("MOPSODSDE_Kmeans");
    ...
    public static void mainexe(PermutationProblem<PermutationSolution<Integer>> problem,
        ...
        if (Nonparametric == false) {
            ...
            for (int i = 0; i < runIndex; i++) {
                ...
                algorithm = new MOPSODSDE_KmeansBuilder(problem, swarmSize, DERate, DEcrossoverRates, DEmutationRate,pmxCrossover)
