...
//import org.uma.jmetal.problem.multiobjective.dfsp.DFSP3;
import org.uma.jmetal.algorithm.impl.AbstractEvolutionaryAlgorithm;
import org.uma.jmetal.algorithm.myimpl.AbstractEvolutionaryAlgorithmS;
...
public abstract class AbstractGeneticAlgorithmS<S, Result> extends AbstractEvolutionaryAlgorithmS<S, Result> {
    protected int maxPopulationSize ;
    protected SelectionOperator<List<S>, S> selectionOperator ;
    protected CrossoverOperator<S> crossoverOperator ;
    protected MutationOperator<S> mutationOperator ;
    //private DFSP3 Clusterindex;
     ...
     */
    public AbstractGeneticAlgorithmS(Problem<S> problem) {
        setProblem(problem);
    }
    ...
    //待定用
    protected List<S> selection1(List<S> population) {
