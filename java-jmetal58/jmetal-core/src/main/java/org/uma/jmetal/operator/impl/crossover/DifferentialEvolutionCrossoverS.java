...
public class DifferentialEvolutionCrossoverS implements   CrossoverOperator<PermutationSolution<Integer>> {
    private double crossoverProbability = 1.0;
    private BoundedRandomGenerator<Integer> cuttingPointRandomGenerator ;
    private RandomGenerator<Double> crossoverRandomGenerator ;
    private PermutationSolution<Integer> currentSolution ;
    private int crossoverprobabilityflag;

    public DifferentialEvolutionCrossoverS() {
        this(0.9, () -> JMetalRandom.getInstance().nextDouble(), (a, b) -> JMetalRandom.getInstance().nextInt(a, b));
    }
     ...
     * Constructor
     */
    public DifferentialEvolutionCrossoverS(double crossoverProbability) {
     ...
     * Constructor
     */
    public DifferentialEvolutionCrossoverS(double crossoverProbability, RandomGenerator<Double> randomGenerator) {
     ...
     * Constructor
     */
    public DifferentialEvolutionCrossoverS(double crossoverProbability, RandomGenerator<Double> crossoverRandomGenerator, BoundedRandomGenerator<Integer> cuttingPointRandomGenerator) {
    ...
    public <S extends PermutationSolution<Integer>> void setCurrentSolution(PermutationSolution<Integer> current) {
        this.currentSolution = current ;
    }

    //public <S extends DoubleSolution> void setCurrentSolution(S s) {
    ...
    @Override
    public int getCrossoverProbabilityflag() {
        return crossoverprobabilityflag;
    }
