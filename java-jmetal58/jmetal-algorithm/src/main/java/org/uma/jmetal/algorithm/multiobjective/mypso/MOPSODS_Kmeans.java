...
public class MOPSODS_Kmeans extends AbstractParticleSwarmOptimization<PermutationSolution<Integer>, List<PermutationSolution<Integer>>> {
    ...
    /** Constructor */
    public MOPSODS_Kmeans(int factories,double crossoverRate, double mutationRate, double rand_k,Problem<PermutationSolution<Integer>> problem, SolutionListEvaluator<PermutationSolution<Integer>> evaluator,
                       int swarmSize, int maxIterations, int upSize, int centralSize, int downSize ,double Qnums) {
        ...
        all3GlobalOptIndividuals = new ArrayList<PermutationSolution<Integer>>(3);
        ...
        for (int i = 0; i < upSize; i++) {
            ...
            for (int k = 0; k < QN; k++) {
                ...
                if (k == 0) {
                    ...
                    getswarm1=learn(actionIndex, R, Q, groupU1Solution.get(i), next,group);
                    int Qiannext = next;
                    if ((getswarm1.getObjective(0) < groupU1Solution.get(i).getObjective(0) && getswarm1.getObjective(1) < groupU1Solution.get(i).getObjective(1)) || getswarm1.getObjective(0) < groupU1Solution.get(i).getObjective(0) ||getswarm1.getObjective(1) < groupU1Solution.get(i).getObjective(1)) next = 0;
                    else next = 1;
                    old0=groupU1Solution.get(i).getObjective(0);old1=groupU1Solution.get(i).getObjective(1);
                ...
                max[k]=groupU1Solution.get(i).getObjective(0)-getswarm1.getObjective(0)+(groupU1Solution.get(i).getObjective(1)-getswarm1.getObjective(1));
        ...
        for (int i = 0; i < centralSize; i++) {
            ...
            for (int k = 0; k < QN; k++) {
                ...
                if (k == 0) {
                    ...
                    getswarm1=learn(actionIndex, R, Q, groupC2Solution.get(i), next,group);
                    int Qiannext = next;
                    if ((getswarm1.getObjective(0) < groupC2Solution.get(i).getObjective(0) && getswarm1.getObjective(1) < groupC2Solution.get(i).getObjective(1)) ||getswarm1.getObjective(0) < groupC2Solution.get(i).getObjective(0) ||getswarm1.getObjective(1) < groupC2Solution.get(i).getObjective(1)) next = 0;
                    else next = 1;

                    old0=groupC2Solution.get(i).getObjective(0);old1=groupC2Solution.get(i).getObjective(1);
                    new0=getswarm1.getObjective(0);new1=getswarm1.getObjective(1);
                    Q[Qiannext][actionIndex] = calculateNewQ1(R, Q,actionIndex,next,Qiannext,old0,old1,new0,new1);
                ...
                max[k]=groupC2Solution.get(i).getObjective(0)-getswarm1.getObjective(0)+(groupC2Solution.get(i).getObjective(1)-getswarm1.getObjective(1));
                temp.add(k,getswarm1);
            }
            int best=0;
            for(int y=1;y<QN;y++){
        ...
        for (int i = 0; i < downSize; i++) {
            ...
            for (int k = 0; k < QN; k++) {
                ...
                if (k == 0) {
                    ...
                    getswarm1=learn(actionIndex, R, Q, groupD3Solution.get(i), next,group);
                    int Qiannext = next;
                    if ((getswarm1.getObjective(0) < groupD3Solution.get(i).getObjective(0) && getswarm1.getObjective(1) < groupD3Solution.get(i).getObjective(1)) || getswarm1.getObjective(1) < groupD3Solution.get(i).getObjective(1) ||getswarm1.getObjective(0) < groupD3Solution.get(i).getObjective(0) ) next = 0;
                    else next = 1;

                    old0=groupD3Solution.get(i).getObjective(0);old1=groupD3Solution.get(i).getObjective(1);
                    new0=getswarm1.getObjective(0);new1=getswarm1.getObjective(1);
                    Q[Qiannext][actionIndex] = calculateNewQ1(R, Q,actionIndex,next,Qiannext,old0,old1,new0,new1);
                    //Q[Qiannext][actionIndex] = calculateNewQ(R, Q,actionIndex,next,Qiannext);
                } else {
                ...
                max[k]=groupD3Solution.get(i).getObjective(0)-getswarm1.getObjective(0)+(groupD3Solution.get(i).getObjective(1)-getswarm1.getObjective(1));
                temp.add(k,getswarm1);
            }
            int best=0;
            for(int y=1;y<QN;y++){
