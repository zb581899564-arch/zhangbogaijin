...
public class P25EAuthorMOPSO extends AbstractParticleSwarmOptimization<PermutationSolution<Integer>, List<PermutationSolution<Integer>>> {
    ...
    /** Constructor */
    public P25EAuthorMOPSO(double crossoverRate, double mutationRate, double rand_k,Problem<PermutationSolution<Integer>> problem, SolutionListEvaluator<PermutationSolution<Integer>> evaluator,
    ...
    protected void updateVelocity(List<PermutationSolution<Integer>> swarm)  {
        org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.recordEvent("MOPSO_VELOCITY_UPDATE");
        double r1, r2;
        double c, m;
...
//        sleep();
    ...
    @Override public String getName() {
        return "P25EAuthorMOPSO" ;
    }

    @Override public String getDescription() {
        return "Optimized P25EAuthorMOPSO" ;
    }
