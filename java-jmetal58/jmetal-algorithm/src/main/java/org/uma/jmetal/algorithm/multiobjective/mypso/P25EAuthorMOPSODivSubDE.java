...
public class P25EAuthorMOPSODivSubDE extends AbstractParticleSwarmOptimization<PermutationSolution<Integer>, List<PermutationSolution<Integer>>> {
     ...
     * Constructor
     */
    public P25EAuthorMOPSODivSubDE(int factories, double crossoverRate, double mutationRate, double rand_k,
...
//        System.out.println("P25EAuthorMOPSODivSubDE 构造函数参数：");
...
//        }
    ...
    protected List<PermutationSolution<Integer>> createInitialSwarm() {
        ...
        //Random A = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.newRandom();
...
//        all3GlobalOptIndividuals.add(globallyOptimalIndividual.get(temp));
    ...
    public double learnG1(int a, double[][] R, double[][] Q, List<PermutationSolution<Integer>> bestsolution, int next1,int group) {
        org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.recordEvent("HMOPSO_QLS_Q_LEARNING");
...
/*        List<PermutationSolution<Integer>> swarmFac = new ArrayList<PermutationSolution<Integer>>(swarmSize/2);
        ...
        org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.log(swarmFac);
...
//        }
        ...
        for (int i = 0; i < upSize; i++) {
            org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.log(i);
...
//对0，1，2工厂的工件顺序排列
    ...
    public PermutationSolution<Integer> worker_load_balancing(PermutationSolution<Integer> solution, List<Integer> selectFac) {
        int[][][] workerinfactory = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.workerDomain();
        Random r = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.newRandom();
...
//        System.out.println(solution);
        int[][][] workerinfactory = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.workerDomain();
        double[][] lw = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.workerEfficiencies();
...
//        sleep();
    ...
    private void addNew4FactoryVectorByRandom(PermutationSolution<Integer> arr, ArrayList<ST> list) {
        ST s;
        Random random = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.newRandom();
        int factorysize = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.machineCounts().length;
