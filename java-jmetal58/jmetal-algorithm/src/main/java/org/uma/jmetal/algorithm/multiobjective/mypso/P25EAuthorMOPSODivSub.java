...
public class P25EAuthorMOPSODivSub extends AbstractParticleSwarmOptimization<PermutationSolution<Integer>, List<PermutationSolution<Integer>>> {
...
//    private int archiveSize;
    ...
    /** Constructor */
    public P25EAuthorMOPSODivSub(int factories,double crossoverRate, double mutationRate, double rand_k,Problem<PermutationSolution<Integer>> problem, SolutionListEvaluator<PermutationSolution<Integer>> evaluator,
...
/////////////////////////////////////////////////////////////
    ...
    protected void updatePosition(List<PermutationSolution<Integer>> swarm)  {
        org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.recordEvent("MOPSODS_DE_GROUPED_UPDATE");
        Random random = org.uma.jmetal.algorithm.multiobjective.mypso.v35.p25e.V35P25EAuthorRuntime.newRandom();
        double r1, r2;
        double c, m;
        double m_worker;
