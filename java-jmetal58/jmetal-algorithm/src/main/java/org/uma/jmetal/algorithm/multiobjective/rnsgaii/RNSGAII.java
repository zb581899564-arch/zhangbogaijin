...
//                 List<Double> interestPoint, double epsilon,double crossoverRate, double mutationRate) {
//    super(problem,maxEvaluations, populationSize,matingPoolSize, offspringPopulationSize, crossoverOperator,
//            mutationOperator,selectionOperator, new DominanceComparator<S>(), evaluator,crossoverRate,mutationRate);
