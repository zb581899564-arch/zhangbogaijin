#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Package-level evidence manifest for 09-v5-sa-hard-500k.
...
HERE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # 09-v5-sa-hard-500k
COLD = "G:/ResearchArchive/ZhangBo-V35-Paper-Evidence-20260823/packages/v35-source-attribution-v5-sa-hard-500k"
