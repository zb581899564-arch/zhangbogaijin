#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""V35-SOURCE-ATTRIBUTION-500K / 10-v5-sa-normal-500k — lifecycle attribution by producing source.
...
This script:
  ...
  3. merges the corrected life_* columns into 04-hard-normal-analysis/source-window-metrics.csv
...
OUT = os.path.join(PKG, "04-hard-normal-analysis")
WINDOW_FE = 25000
